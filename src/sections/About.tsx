      ...
      whileHover={
        enableTilt
          ? {
              ...
              scale: 1.02,
              boxShadow:
                "0 18px 40px -18px rgba(216,207,188,0.28)",
            }
          : undefined
      }
      whileTap={
    ...
    >
      ...
      <div
        ...
        className="
          ...
          transition-shadow
          duration-300
          group-hover:shadow-[0_0_20px_-4px_rgba(216,207,188,0.45)]
          sm:mb-6
        "
      >
        <Icon
        ...
        >
          ...
          >
            ...
            <p
              ...
              "
            >
              I work across both frontend
              and backend development,
              with a focus on Java, React,
              Next.js and database-driven
              applications.
            </p>
