...
const GMAIL_COMPOSE_URL =
  ...
  `&su=${encodeURIComponent("Hello Sarvesh")}`;
...
function MagneticButton({
  ...
  const springRX = useSpring(rX, {
    stiffness: 250,
    damping: 20,
    mass: 0.4,
  });

  const springRY = useSpring(rY, {
    stiffness: 250,
    damping: 20,
    mass: 0.4,
  });
      ...
      >
        ...
        >
          ...
          >
            ...
            an opportunity to discuss, or simply
        ...
        >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    learning new things and creating
          ...
          <div className="flex flex-col gap-3">
            ...
            <motion.div
              ...
              style={{
                animation: enableMotion
                  ? "float-y 5s ease-in-out infinite"
                  : undefined,
              }}
            >
              <TiltCard
              ...
              >
                <div
                  className="
                    ...
                    bg-[#151610]
                    p-5
                    shadow-[0_20px_45px_-25px_rgba(0,0,0,0.7)]
                  "
                >
                  <div
                    className="
